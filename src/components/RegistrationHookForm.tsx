        ...
        <>
            <form className="form" onSubmit={handleSubmit(onsubmit)}>
                <div className="form__item">
                    ...
                    {errors.name && <p className="form__error">{errors.name.message ? errors.name.message : "Name is required"}</p>}
                </div>
                <div className="form__item">
                    <div className="form__field">
                ...
                <div className="form__item">
                    ...
                    {errors.password && <p className="form__error">{errors.password.message ? errors.password.message : "Password is required"}</p>}
                </div>
